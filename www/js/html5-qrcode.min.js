...
1000)}else setTimeout(svan,500)};window.URL=window.URL||window.webkitURL||window.mozURL||window.msURL;navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia;e=function(a){h.src=window.URL&&window.URL.createObjectURL(a)||a;localMediaStream=a;h.play();setTimeout(k,1E3)};navigator.getUserMedia?navigator.getUserMedia({video:!0},e,b):console.log("Native web camera streaming (getUserMedia) not supported in this browser.");qrcode.callback=
a}})(jQuery);